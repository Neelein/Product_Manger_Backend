...
func main() {
	...
	p1 := domain.Product{Name: "測試商品 A", Price: 100, Category: "test"}
	must(repo.Create(ctx, &p1))
	fmt.Printf("✅ 新增 — ID: %s, Name: %s\n", p1.ID, p1.Name)

	p2 := domain.Product{Name: "測試商品 B", Price: 200, Category: "test"}
	...
	p3 := domain.Product{Name: "測試商品 C", Price: 300, Category: "test"}
