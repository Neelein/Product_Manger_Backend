.PHONY: db db-stop db-rm server server-stop test test-integration test-integration-productdb seed-storefront-e2e seed-integration
...
seed-integration:
	go run ./src/test/seed_integration
